...
export const SearchAdmiro: string = "Type to Search...";
export const SearchAdmiroTheme: string = "Search Admiro ..";
...
export const AdmiroMatchettVandelayGroupLTD: string = "Admiro Matchett Vandelay Group LTD";
...
export const CustomModalsTitle: string = "Admiro custom modals";
//Helper classes
...
export const AdmiroTheme: string = "Admiro Theme";
...
export const LinkedInPlaceholder: string = "https://linkedIn.com/admiro";
export const GitHubPlaceholder: string = "https://github.com/admiro";
export const TwitterPlaceholder: string = "https://twitter.com/admiro";
...
export const AdmiroMail: string = "admori@example.com";
