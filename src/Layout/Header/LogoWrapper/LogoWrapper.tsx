...
const LogoWrapper = () => {
  ...
  return (
    <div className="logo-wrapper d-flex align-items-center col-auto">   
        <Image width={120} height={60} priority className="light-logo img-fluid" src={`${ImagePath}/logo/logo1.png`} alt="logo" />
        <Image width={120} height={60} priority className="dark-logo img-fluid" src={`${ImagePath}/logo/logo-dark.png`} alt="logo" />
