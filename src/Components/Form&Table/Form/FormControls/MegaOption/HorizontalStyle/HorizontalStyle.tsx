...
import { HorizontalStyleData } from "@/Data/Form&Table/Form/FormControls";
  ...
  return (
    <Col sm="12" xxl="6" className="box-col-12">
      <Card className="height-equal">
        ...
        <CommonCardFooter footerClass="text-end" color1="primary" btn1Class='m-r-15' color2="light text-dark" />
      </Card>
    </Col>
  )
};
