...
import { UpgradeVariationData } from "@/Data/Form&Table/Form/FormControls";
      ...
      <div className="card-wrapper border rounded-3 h-100 checkbox-checked">
        <section className="main-upgrade">
          <div>
            ...
            <h5 className="mb-2">
              {UpgradeTitle} <span className="text-primary">{UpgradeSpanText}</span>
            </h5>
            ...
            {UpgradeVariationData.map(({ id, check, text, sales }, index) => (
              <div className="selection-box" key={index}>
                ...
                <div className="custom--mega-checkbox">
                  <ul>
                    <li>{text}</li>
                    <li className="text-primary">{sales}</li>
                  </ul>
                </div>
              </div>
            ))}
