        ...
        <CardBody>
          <div className="clipboaard-container">
            ...
            <div className="mt-3 text-end">
                <Button color="primary" className="btn-clipboard me-1" onClick={handleCopy}><i className="fa fa-copy"></i> {Copy}</Button>
                <Button color="secondary" className="btn-clipboard-cut" onClick={handleCut}><i className="fa fa-cut"></i> {Cut}</Button>
            </div>
          </div>
        </CardBody>
      </Card>
