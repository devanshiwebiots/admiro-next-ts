...
import { setStudentValidationForm } from "@/Redux/Reducers/FormLayout/FormWizardOneSlice";

const StudentValidationFormCardBody = () => {
  const { studentValidationForm, studentLevel } = useAppSelector((state) => state.formWizardOne);
