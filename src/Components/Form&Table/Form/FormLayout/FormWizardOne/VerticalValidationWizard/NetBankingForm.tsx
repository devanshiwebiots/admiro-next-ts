...
import { bankingNextHandler, setNetBankingForm } from "@/Redux/Reducers/FormLayout/FormWizardOneSlice";

const NetBankingForm = () => {
  const { netBankingFormValues } = useAppSelector((state) => state.formWizardOne);
