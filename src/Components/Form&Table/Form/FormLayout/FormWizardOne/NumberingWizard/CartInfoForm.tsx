...
import { AboveInformationCorrect, AdharaPlaceholder, CVVNumber, CardNumber, Expiration, ExpiryPlaceholder, PlaceHolderName, PlaceholderName, UploadDocumentation } from "@/Constant";
  ...
  return (
    <Form className="stepper-two needs-validation custom-input" noValidate>
      <Row>
        <Col md="12">
          <FormGroup>
            <Label check className="form-label">{PlaceHolderName}</Label>
