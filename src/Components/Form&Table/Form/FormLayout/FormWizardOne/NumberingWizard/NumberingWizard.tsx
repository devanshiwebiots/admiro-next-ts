...
import { handleBackButton, handleNextButton, setBasicInputFormValue } from "@/Redux/Reducers/FormLayout/FormWizardOneSlice";
import { NumberWizardData } from "@/Data/Form&Table/Form/FormLayout";
import CommonCardHeader from "@/CommonComponent/CommonCardHeader";

const NumberingWizard = () => {
  const { numberLevel,basicInputFormValue, showFinish } = useAppSelector((state)=>state.formWizardOne)
