  ...
  return (
    <Form className="stepper-three needs-validation custom-input" noValidate>
      <Row>
        <Col sm="6">
          <FormGroup>
            <Label check className="form-label">{LinkedIn}<span className="text-danger">*</span></Label>
            <Input name="linkedInLink" value={linkedInLink} onChange={getUserData} type="url" placeholder={LinkedInPlaceholder} />
          </FormGroup>
        </Col>
        <Col sm="6">
          <FormGroup>
            <Label check className="form-label">{Github}<span className="text-danger">*</span></Label>
            <Input name="gitHubLink" value={gitHubLink} onChange={getUserData} type="url" placeholder={GitHubPlaceholder} />
          </FormGroup>
        </Col>
        <Col xs="12">
          <FormGroup>
            <Label check className="form-label">{SelectState}<span className="text-danger">*</span></Label>
        ...
        <Col xs="12">
          <FormGroup>
            <Label className="form-label">{GiveFeedback}</Label>
