...
import { AlertTitle, BadgesTable, CheckboxTitle, InputsTable, ProgressbarTitle, RadioButtonsTitle, ReactstrapTable, SelectTable, SwitchTable, TableComponents, TooltipTriggersTitle, UIComponentsTitle } from "@/Constant";
...
const TableComponentContainer = () => {
  return (
    <>
      <Breadcrumbs mainTitle={TableComponents} parent={ReactstrapTable} />
      <Container fluid>
        <Row>
