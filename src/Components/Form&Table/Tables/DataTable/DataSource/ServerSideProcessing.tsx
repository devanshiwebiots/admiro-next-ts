...
import { ServerColumn, ServerData } from "@/Data/Form&Table/Table/DataTable/DataSourceDataTables";
    ...
    <Col sm="12">
      <Card>
        <CardHeader className="pb-0 card-no-border">
          <h3 className="mb-3">{ServerSideProcessingHeading}</h3>
          ...
          <span>
            ...
            option to <code>true</code> and providing an Ajax data source through the
            <code className="option" title="DataTables initialisation option">
              ajax:option
            </code>
            option.
