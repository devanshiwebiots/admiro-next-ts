...
const AddRows = () => {
  ...
  return (
    <Col sm="12">
      <Card>
        <CardHeader>
          <h3 className="mb-3">Add rows </h3>
          <span>
            New rows can be added to a DataTable using the
            <code className="api" title="DataTables API method">row.add()</code>
            ...
            <code className="api" title="DataTables API method">rows.add()</code>
            method (note the plural). Data can likewise be updated with the
            <code className="api" title="DataTables API method">row().data()</code>and
            <code className="api" title="DataTables API method">row().remove()</code>methods.
          </span>
          <span>
            Note that in order to see the new row in the table you must call the
            <code className="api" title="DataTables API method">draw()</code>
