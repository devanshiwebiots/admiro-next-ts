    ...
    <Modal isOpen={addModal} toggle={addToggle} size="lg" className="modal-bookmark">
      ...
      <ModalBody>
        <Form className="form-bookmark needs-validation" onSubmit={handleSubmit(onSubmit)}>
          <Row>
            ...
            <Col md="6">
              <FormGroup className="mb-3 mt-0">
                ...
                <Input type="select" name="group" className="form-control js-example-basic-single">
            ...
            <Col md="6">
              <FormGroup>
                ...
                <Input type="select" name="collection" className="form-control js-example-disabled-results">
          ...
          <Button color="secondary" className="me-2" type="submit" onClick={()=>dispatch(setBookmarkValidation(true))}>{Save}</Button>
