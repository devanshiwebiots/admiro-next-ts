...
export const HoverButtons: React.FC<HoverButtonsProp> = ({ item, setDataId, setOpenModal }) => {
  ...
  return (
    <div className="product-hover">
      <ul>
        <li>
          <Button color="transparent" onClick={() => AddToCarts(item, 1)}><i className="icon-shopping-cart"></i></Button>
        </li>
        <li>
          <Button color="transparent" onClick={() => onClickHandle(item)}><i className="icon-eye"></i></Button>
        </li>
      </ul>
    </div>
  );
