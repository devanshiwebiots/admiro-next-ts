      ...
      <Modal isOpen={modal} toggle={toggle} size="lg" >
        ...
        <ModalBody className="custom-input">
          <div className="create-category">
            <Label for="validationServer01" check>{CategoryName} <span className="text-danger"> *</span></Label>
        ...
        <ModalFooter>
          <Button color="light" className="font-dark" onClick={toggle}> {Cancel}</Button>
