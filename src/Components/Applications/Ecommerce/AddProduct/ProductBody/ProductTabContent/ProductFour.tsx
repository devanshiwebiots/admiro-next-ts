    ...
    <div className="sidebar-body">
      <Form className="price-wrapper">
        <Row className="g-3 custom-input">
          <Col sm="6">
            <Label check>{InitialCost}<span className="text-danger">*</span></Label>
            <Input type="number" name="initialCost" onChange={(e)=> dispatch(setFormValue({name:"initialCost",value:e.target.value}))}/>
          </Col>
          <Col sm="6">
            <Label check>{SellingPrice} <span className="text-danger">*</span></Label>
          ...
          <Col sm="6">
            <Label check>{ProductStocks}<span className="text-danger">*</span></Label>
