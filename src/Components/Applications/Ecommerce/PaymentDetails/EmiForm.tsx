              ...
              <FormGroup>
                <Col xs="12">
                  <ul className="payment-opt">
                    <li><Image width={34} height={20} src={`${ImagePath}/ecommerce/mastercard.png`} alt="" /></li>
                    <li><Image width={64} height={20} src={`${ImagePath}/ecommerce/visa.png`} alt="" /></li>
                    <li><Image width={78} height={20} src={`${ImagePath}/ecommerce/paypal.png`} alt="" /></li>
                  </ul>
                </Col>
              </FormGroup>
              <Col xs="12">
