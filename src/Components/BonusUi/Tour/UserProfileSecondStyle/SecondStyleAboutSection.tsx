    ...
    <>
      ...
      <div className="img-container">
        <div id="aniimated-thumbnials">
          <Link href={Href}>
            <RatioImage className="img-fluid rounded" src={`${ImagePath}/other-images/profile-style-img3.png`} alt="gallery" />
          </Link>
          <p className="block-ellipsis pt-3">
            {PainterTourSpan}
            <Link className="text-danger ms-1" href="users/user_profile">
              {ReadMoreTour}
            </Link>
          </p>
        </div>
