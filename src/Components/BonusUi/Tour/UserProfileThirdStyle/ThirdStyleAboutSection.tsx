        ...
        <Col sm="6">
          <Link href={Href}>
            <div className="tour-blog">
              <Image width={766} height={350} className="img-fluid rounded" src={`${ImagePath}/other-images/mountain.jpg`} alt="mountain" />
            </div>
          </Link>
        </Col>
        <Col sm="6">
          <Link href={Href}>
            <div className="tour-blog">
              <Image width={766} height={350} className="img-fluid rounded" src={`${ImagePath}/other-images/sea.jpg`} alt="sea" />
            </div>
          </Link>
        </Col>
      </Row>
