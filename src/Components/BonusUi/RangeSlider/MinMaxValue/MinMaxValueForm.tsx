            ...
            <div style={{ color: "#FF6150" }} className="d-flex justify-content-center flex-wrap m-3">
              <Range
                ...
                renderThumb={({ props ,index}) => (
                  <div {...props} className="d-flex justify-content-center align-items-center rounded-5" key={index} style={{ ...props.style, height: "25px", width: "25px", border: "3px solid #FF6150", backgroundColor: "#FFF", boxShadow: "0px 2px 6px #AAA" }}>
