...
import { Agreewith, CreateAccount, CreateYourAccount, EmailAddress, Href, Password, SignIn, YourName } from "@/Constant";
...
export const RegisterForm: React.FC<LoginFormProp> = ({ logoClass }) => {
  ...
  const handleSubmit = (e: FormEvent<HTMLFormElement>) => {e.preventDefault();setFormData({ name: "", lastName: "", email: "", password: "", checkbox1: false });};
  return (
    <div>
      ...
      <div className="login-main">
        <Form className="theme-form" onSubmit={handleSubmit}>
          ...
          <FormGroup className="mb-0 checkbox-checked">
            ...
            <Button color="primary" className="w-100 mt-3" block>{CreateAccount}</Button>
          </FormGroup>
