...
import { CategoryTableDataColumnType, CategoryTableProduct, OrderHistoryImageType, OrderHistoryTableColumns, ProductListTableDataColumnType, ProductListTableProduct } from "@/Types/EcommerceType";
...
const CategoryTableProductName: React.FC<CategoryTableProduct> = ({ images, name }) => {
  return (
...
const CategoryTableStatus: React.FC<CategoryTableProduct> = ({ name }) => {
  return (
    <Badge color="" className={`badge-light-${name === "Accessories" ? "secondary" : `${name === "Electronic" ? "success" : "primary"}`}`}>
      {name}
    </Badge>
  );
};

export const CategoryPageTableDataColumn = [
  {
    name: "Category",
    selector: (row: CategoryTableDataColumnType) => row.name,
    cell: (row: CategoryTableDataColumnType) => <CategoryTableProductName images={row.image} name={row.name} />,
    sortable: true,
  },
  {
    name: "Description",
    selector: (row: CategoryTableDataColumnType) => `${row.category}`,
    sortable: true,
    grow: 5,
  },
  {
    name: "Category Type",
    selector: (row: CategoryTableDataColumnType) => row.status,
    cell: (row: CategoryTableDataColumnType) => <CategoryTableStatus name={row.status} />,
    sortable: true,
  },
  {
    name: "Action",
...
export const ProductSocialLinks = [
  ...
  },
  {
    ...
    text: "fa-brands fa-google-plus-g",
  },
  {
