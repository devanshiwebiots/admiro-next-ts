...
export const HoverableRowBody = [
  {
    id: 1,
    icon: <AlertTriangle className="bg-light-success font-success me-3" />,
    color: "success",
    status: "No Signal",
  ...
  {
    id: 2,
    icon: <AlertTriangle className="bg-light-danger font-danger me-3" />,
    color: "danger",
    status: "Offline",
  ...
  {
    id: 3,
    icon: <AlertCircle className="bg-light-primary font-primary me-3" />,
    color: "primary",
    status: "Online",
  ...
  {
    id: 4,
    icon: <CheckCircle className="bg-light-success font-success me-3" />,
    color: "success",
    status: "No Signal",
    signalName: "Astrid: NE Shared managed",
    security: "Negligible",
  ...
  {
    id: 5,
    icon: <CheckCircle className="bg-light-danger font-danger me-3" />,
    color: "danger",
    status: "Online",
    signalName: "Astrid: NE Shared managed",
    security: "Medium",
