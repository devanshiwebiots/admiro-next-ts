export const BasicTypeHeadData = [{ text: "This is the simple demo for Typeahead." }];
...
export const PreFetchData = [{ text: "Prefetched data is fetched and processed on initialization" }];
...
export const BloodHoundData = [{ text: "Bloodhound offers advanced functionalities such as prefetching and backfilling with remote data." }];

export const RemoteTypeHeadData = [{ text: "Remote data is only used when the data provided by local and prefetch is insufficient" }];
...
export const CustomTemplateData = [{ text: "Custom templates give you full control over how suggestions get rendered" }];
...
export const MultipleSectionHeaderData = [{ text: "Two datasets that are prefetched, stored, and searched on the client. Highlighting is enabled." }];
...
export const ScrollableDropdownData = [{ text: "Dataset shows in scrollable dropdown menu." }];

export const RtlSupportData = [{ text: "Dataset shows in Right Side." }];
